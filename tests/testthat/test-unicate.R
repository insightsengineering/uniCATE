# integration tests
test_that("biomarkers 1 and 2 found by unicate() with SL (cont. outcome)", {
  library(dplyr)
  library(sl3)
  set.seed(6132451)
...
test_that("biomarkers 1 and 2 found by unicate() with default learner (cont.
          outcome)", {
  library(dplyr)
  library(sl3)
  set.seed(6132451)
...
test_that("biomarkers 1 and 2 found by unicate() with SL (binary outcome)", {
  library(dplyr)
  library(purrr)
  set.seed(6132451)
...
test_that("biomarkers 1 and 2 found by unicate() with default learner (binary
          outcome)", {
  library(dplyr)
  library(purrr)
  set.seed(6132451)
